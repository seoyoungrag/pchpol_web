...
<div class="wrap_hide">   
    <div class="wrap">
        ...
        <section class="contents sub">
          ...
          <h2><a class="btn_back" href="javascript:history.back();"><img src="${pageContext.request.contextPath}/mobile/resources/images/ico-btn-back.png" alt="뒤로가기" /></a>상황보고</h2>
          <div class="con">
					...
					<c:forEach items="${root}" var="board" >
						<tr>
		                    ...
		                    <td class="tit" boardNo="${board.boardNo }">
								<a href="#" onclick="javascript:goBoard(this);">
            ...
            <div class="btn_wrap txt-center">
                <a class="btn single_btn bg_navy txt-light" href="./write.do">상황보고 작성</a><!-- report_write.html -->
            </div>
