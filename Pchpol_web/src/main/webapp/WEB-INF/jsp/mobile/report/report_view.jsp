...
function goModify(){
	var url = "./modify.do?curBoardNo=${curBoardNo}&prevBoardNo=${prevBoardNo}&nextBoardNo=${nextBoardNo}";
				...
				<div class="con board">
						...
						<dl class="tittle">
							<dd>
								<span class="table_cell ">
									<p class="tit">
										<span>
										<c:if test="${!empty board.boardSubCategory }">
										[${board.boardSubCategory }]
										</c:if>
					...
					<ul class="list_btn_wrap">
						...
						<li class="prev">
							...
							<a href="#" onclick="javascript:goAnotherBoard('${prevBoardNo }','prev')">
							<c:if test="${!empty prevBoardSubCategory }">
							[${prevBoardSubCategory }]
							</c:if>
							${prevBoardTitle }</a>
						</li>
						</c:if>
						...
						<li class="next">
							...
							</span> <a href="#" onclick="javascript:goAnotherBoard('${nextBoardNo }','next')">
							<c:if test="${!empty nextBoardSubCategory }">
							[${nextBoardSubCategory }]
							</c:if>
							${nextBoardTitle }</a>
						</li>
						</c:if>
